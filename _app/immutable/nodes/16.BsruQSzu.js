import{f as d,a as l}from"../chunks/BlpcOEXb.js";import{az as k,p as g,a as b,c as f,s as O,r as _,t as P}from"../chunks/Dxi7U2qW.js";import{i as T}from"../chunks/DbYDBPP3.js";import{a as y}from"../chunks/n3U_t9fx.js";import"../chunks/Cxxp1rXc.js";import{B as E}from"../chunks/LqpeH5Lk.js";import{D as I}from"../chunks/DMvn4Q5j.js";import{i as v,h as a,D as N,E as U,k as w,l as B,m as C,v as A,b as R,y as S}from"../chunks/DftDRX0W.js";import{d as L}from"../chunks/s48E5ACk.js";import{c as D}from"../chunks/BxJPPFTr.js";const x=!0,ut=Object.freeze(Object.defineProperty({__proto__:null,prerender:x},Symbol.toStringTag,{value:"Module"}));var F=d('<h3>About Timeout</h3> <p>A timeout contract holds assets (cash or tokens) during a timeout period. If not withdrawn or ‘refreshed’ within the timeout window, all funds will be sent to the pre-defined receipt.</p> <p><strong>⚠️ Note: Funds will be sent to the pre-defined receipt if not moved BEFORE timeout expires.</strong></p> <p>More about the <a href="https://bitcoincashresearch.org/t/unspent-phi-v3-timelocking-token-aware-contracts/1501#relative-timelock-bip68-deadman-switch-or-last-will-vault-with-cashtoken-support-2" rel="nofollow">contract here</a></p> <h3>See also:</h3> <p><a href="https://github.com/KarolTrzeszczkowski/Electron-Cash-Last-Will-Plugin" rel="nofollow">Last Will</a> by Karol Trzeszczkowski (Licho#14431)</p>',1);function M(p){var e=F();k(10),l(p,e)}const X="https://libauth.org/schemas/wallet-template-v0.schema.json",q='Timeout: a "deadman"-style asset vault.',V="Timeout",H={covenant:{description:`Lock assets on a deadman timeout. 
...
OP_CHECKSIG`}},Q=["BCH_2026_05","BCH_SPEC"],z={$schema:X,description:q,name:V,entities:H,scenarios:K,scripts:Y,supported:Q},W="@unspent/timeout",$={name:W};class j{static PROTOCOL_IDENTIFIER="U3T";static USER_AGENT=$.name;static EXECUTOR_FEE=2500;static tokenAware=!0;static template=z;static compiler=v(this.template);static vm=D();static dataToBytecode(e){return{recipient:a(e.recipient),timeout:N(e.timeout),auth:a(e.auth)}}static parseCommitment(e){typeof e=="string"&&(e=a(e));const t=L(e);if(U(t[0])!==this.PROTOCOL_IDENTIFIER)throw Error(`"Non-${typeof this} record NFT passed as ${typeof this}"`);return{recipient:t[1],timeout:t[2],auth:t[3]}}static encodeCommitment(e){const t=this.dataToBytecode(e);return this.getLockingBytecode(t)}static getLockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(e,t=!0){return w(this.getLockingBytecode(e),t)}static getAddress(e,t="bitcoincash"){return B(this.getLockingBytecode(e),t,this.tokenAware)}static getSourceOutput(e,t){return{lockingBytecode:this.getLockingBytecode(e),valueSatoshis:BigInt(t.value),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getInput(e,t){return{outpointIndex:t.tx_pos,outpointTransactionHash:a(t.tx_hash),sequenceNumber:t.value,unlockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static getOutput(e,t){return{lockingBytecode:e.recipient,valueSatoshis:BigInt(t.value-this.EXECUTOR_FEE),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getSourceOutputs(e,t){const n=[];return n.push(...t.map(s=>this.getSourceOutput(e,s))),n}static process(e,t){let r={locktime:0,version:2,inputs:[],outputs:[]},c=this.parseCommitment(e);r.inputs.push(this.getInput(c,t)),r.outputs.push(this.getOutput(c,t));let u=C(r);if(!u.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(u.errors,null,"  "));const i=[this.getSourceOutput(c,t)],o=u.transaction,m=A(o,i,{maximumTokenCommitmentLength:40});if(m!==!0)throw m;let h=this.vm.verify({sourceOutputs:i,transaction:o});if(typeof h=="string")throw h;return R(S(o))}}var G=d('<img alt="Disconnected"/>'),J=d('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function pt(p,e){g(e,!0);var t=J(),n=f(t),s=f(n);E(s,{get template(){return j.template}});var r=O(s,2);{var c=i=>{var o=G();P(()=>y(o,"src",I)),l(i,o)};T(r,i=>{i(c,!1)})}_(n);var u=O(n,2);M(u),_(t),l(p,t),b()}export{pt as component,ut as universal};
//# sourceMappingURL=16.BsruQSzu.js.map
