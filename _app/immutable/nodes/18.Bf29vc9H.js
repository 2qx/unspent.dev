...
OP_CHECKSIG`}},Q=["BCH_2026_05","BCH_SPEC"],z={$schema:X,description:V,name:q,entities:H,scenarios:K,scripts:Y,supported:Q},W="@unspent/timeout",G={name:W};class ${static PROTOCOL_IDENTIFIER="U3T";static USER_AGENT=G.name;static EXECUTOR_FEE=2500;static tokenAware=!0;static template=z;static compiler=v(this.template);static vm=N();static dataToBytecode(e){return{recipient:a(e.recipient),timeout:U(e.timeout),auth:a(e.auth)}}static parseCommitment(e){typeof e=="string"&&(e=a(e));const t=D(e);if(w(t[0])!==this.PROTOCOL_IDENTIFIER)throw Error(`"Non-${typeof this} record NFT passed as ${typeof this}"`);return{recipient:t[1],timeout:t[2],auth:t[3]}}static encodeCommitment(e){const t=this.dataToBytecode(e);return this.getLockingBytecode(t)}static getLockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(e,t=!0){return B(this.getLockingBytecode(e),t)}static getAddress(e,t="bitcoincash"){return C(this.getLockingBytecode(e),t,this.tokenAware)}static getSourceOutput(e,t){return{lockingBytecode:this.getLockingBytecode(e),valueSatoshis:BigInt(t.value),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getInput(e,t){return{outpointIndex:t.tx_pos,outpointTransactionHash:a(t.tx_hash),sequenceNumber:t.value,unlockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static getOutput(e,t){return{lockingBytecode:e.recipient,valueSatoshis:BigInt(t.value-this.EXECUTOR_FEE),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getSourceOutputs(e,t){const n=[];return n.push(...t.map(s=>this.getSourceOutput(e,s))),n}static process(e,t){let r={locktime:0,version:2,inputs:[],outputs:[]},c=this.parseCommitment(e);r.inputs.push(this.getInput(c,t)),r.outputs.push(this.getOutput(c,t));let u=A(r);if(!u.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(u.errors,null,"  "));const i=[this.getSourceOutput(c,t)],o=u.transaction,h=R(o,i,{maximumTokenCommitmentLength:40});if(h!==!0)throw h;let m=this.vm.verify({sourceOutputs:i,transaction:o});if(typeof m=="string")throw m;return S(L(o))}}var j=d('<img alt="Disconnected"/>'),J=d('<section><div class="status svelte-15is90k"><!> <!></div> <!></section>');function ut(p,e){g(e,!0);var t=J(),n=f(t),s=f(n);E(s,{get template(){return $.template}});var r=O(s,2);{var c=i=>{var o=j();P(()=>y(o,"src",I)),l(i,o)};T(r,i=>{i(c,-1)})}_(n);var u=O(n,2);M(u),_(t),l(p,t),b()}export{ut as component,ct as universal};
//# sourceMappingURL=18.Bf29vc9H.js.map
