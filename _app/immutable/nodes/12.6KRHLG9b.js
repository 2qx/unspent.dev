...
// }
//}`}},W=["BCH_2023_05","BCH_SPEC"],Z=0,tt={$schema:$,description:j,name:Q,entities:G,scenarios:J,scripts:z,supported:W,version:Z},et="@unspent/locktime",nt={name:et};class ot{static USER_AGENT=nt.name;static PROTOCOL_IDENTIFIER="U3L";static EXECUTOR_FEE=2500;static tokenAware=!0;static template=tt;static compiler=L(this.template);static vm=q();static dataToBytecode(e){return{locktime:C(e.locktime),recipient:a(e.recipient)}}static parseNFT(e){if(e.token_data?.nft?.commitment){let t=V(a(e.token_data?.nft?.commitment));if(A(t[0])!==this.PROTOCOL_IDENTIFIER)throw Error("Non-locktime record NFT passed as locktime");return{recipient:t[1],locktime:t[2]}}else throw Error("Could not parse locktime NFT")}static encodeCommitment(e){let t=R(`<"${this.PROTOCOL_IDENTIFIER}"><0x${e.recipient}><${e.locktime}>`);if(typeof t=="string")throw t;return w(t)}static getLockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(e,t=!0){return D(this.getLockingBytecode(this.parseNFT(e)),t)}static getAddress(e,t="bitcoincash"){let n=this.dataToBytecode(e);return S(this.getLockingBytecode(n),t,this.tokenAware)}static getSourceOutput(e,t){return{lockingBytecode:this.getLockingBytecode(e),valueSatoshis:BigInt(t.value),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getInput(e,t){return{outpointIndex:t.tx_pos,outpointTransactionHash:a(t.tx_hash),sequenceNumber:0,unlockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}}static getOutput(e,t){let n=t.value>this.EXECUTOR_FEE+800?t.value-this.EXECUTOR_FEE:800n;return{lockingBytecode:e.recipient,valueSatoshis:BigInt(n),token:t.token_data?{category:a(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:a(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getExecutorOutput(e,t){let n=F(e);if(typeof n=="string")throw n;return{lockingBytecode:n.bytecode,valueSatoshis:BigInt(t)}}static execute(e,t,n,l=1){const p=[],m=[];let c=[],o={locktime:t,version:2,inputs:p,outputs:m};for(let r of e){let s=this.parseNFT(r.record);M(s.locktime)<=t&&(o.inputs.push(this.getInput(s,r.utxo)),o.outputs.push(this.getOutput(s,r.utxo)),c.push(this.getSourceOutput(s,r.utxo)))}n&&o.inputs.length>0&&o.outputs.push(this.getExecutorOutput(n,o.inputs.length*this.EXECUTOR_FEE));let i=_(o);if(!i.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(i.errors,null,"  "));if(n&&o.inputs.length>0){const r=X(i.transaction,l)+1n,s=o.outputs.length-1;o.outputs[s].valueSatoshis=o.outputs[s].valueSatoshis-r}if(i=_(o),!i.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(i.errors,null,"  "));const d=i.transaction,f=x(d,c,{maximumTokenCommitmentLength:40});if(f!==!0)throw f;let h=this.vm.verify({sourceOutputs:c,transaction:d});if(typeof h=="string")throw h;return{sourceOutputs:c,transaction:d,verify:h}}}var it=g('<img alt="Disconnected"/>'),at=g('<section><div class="status svelte-1hdjt3z"><!> <!></div> <!></section>');function ft(u,e){I(e,!0);var t=at(),n=O(t),l=O(n);U(l,{get template(){return ot.template}});var p=T(l,2);{var m=o=>{var i=it();v(()=>P(i,"src",B)),k(o,i)};N(p,o=>{o(m,-1)})}E(n);var c=T(n,2);Y(c),E(t),k(u,t),b()}export{ft as component,gt as universal};
//# sourceMappingURL=12.6KRHLG9b.js.map
