import{f,a as u,c as H}from"../chunks/Bof-DaP9.js";import"../chunks/DbLBE8-K.js";import{o as Ot,a as Et}from"../chunks/okCC5NtM.js";import{as as Pt,p as yt,c,t as E,a as xt,j as o,a1 as k,aq as Tt,s as O,G as S,N as z,r as l,f as G}from"../chunks/B310gWAd.js";import{d as It,h as kt,s as wt}from"../chunks/BC1tWXlJ.js";import{i as C}from"../chunks/Co1DboXv.js";import{e as Q,i as K}from"../chunks/DNhhjli6.js";import{b as P,s as g}from"../chunks/C0109kRu.js";import{s as Ut}from"../chunks/jThvpB-v.js";import{i as Dt}from"../chunks/rTzgE6Do.js";import{p as J}from"../chunks/D8-S6pGe.js";import{b as W}from"../chunks/BtgC42a0.js";import{l as V,o as Nt,j as At,t as Bt,r as U,z as Mt,L as Rt,F as St,D as Ct,E as Vt,k as Z,$ as Lt}from"../chunks/DnyN4nng.js";import{B as jt,C as qt,D as Xt}from"../chunks/CStm3022.js";const Ft=2,tt=(b,s=Ft)=>JSON.stringify(b,(n,a)=>{const d=typeof a=="object"&&a!==null?a.constructor.name:typeof a;switch(d){case"Uint8Array":return`<Uint8Array: 0x${V(a)}>`;case"bigint":return`<bigint: ${a.toString()}n>`;case"function":case"symbol":return`<${d}: ${a.toString()}>`;default:return a}},s),$t=!0,De=Object.freeze(Object.defineProperty({__proto__:null,prerender:$t},Symbol.toStringTag,{value:"Module"}));var Yt=f("<h3>About Drip Mine</h3> <p>Drip mine is a contract demonstrating the potential of Miner Extractable Value (MEV). Each output of the contract can be spent by anyone, each transaction generates fees that benefit miner that includes the transaction in a block.</p> <p>Bitcoin has always had builtin MEV, in the form of a block subsidy. The block subsidy, or block reward, is a way to create newly minted coins in the first transaction of a block (the coinbase transaction).</p> <p>As the idea of bitcoin continues to develop, on the Bitcoin Cash (BCH) fork, the built-in block subsidy will become less and less important and revenue from including transactions will come to dominate miner revenue.</p> <p>Anyone-can-spend outputs held by the drip-mine covenant by clicking the colorful icons above.</p> <p>When the value of an unspent transaction output locked by the covenant falls below 740 satoshis, all the value is claimed in the next transaction and the output is ‘burned’.</p> <p>Anyone may contribute to the MEV fund by sending outputs to the address below:</p>",1);function Ht(b){var s=Yt();Pt(12),u(b,s)}const zt="https://libauth.org/schemas/wallet-template-v0.schema.json",Gt=`Drip Mine: An MEV faucet
