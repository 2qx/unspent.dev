...
OP_NIP`}},nt=["BCH_2026_05","BCH_SPEC"],ot={$schema:J,description:z,name:W,entities:Z,scenarios:tt,scripts:et,supported:nt},it="@unspent/locktime",st={name:it};class at{static USER_AGENT=st.name;static PROTOCOL_IDENTIFIER="U3L";static EXECUTOR_FEE=2500;static tokenAware=!0;static template=ot;static compiler=x(this.template);static vm=F();static dataToBytecode(e){return{locktime:M(e.locktime),recipient:u(e.recipient)}}static parseCommitment(e){typeof e=="string"&&(e=u(e));const t=Q(e);if(X(t[0])!==this.PROTOCOL_IDENTIFIER)throw Error(`"Non-${typeof this} record NFT passed as ${typeof this}"`);return{recipient:t[1],locktime:t[2]}}static encodeCommitment(e){const t=this.dataToBytecode(e);return b(this.getLockingBytecode(t))}static getLockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(e,t=!0){return V(this.getLockingBytecode(this.parseCommitment(e)),t)}static getAddress(e,t="bitcoincash"){let n=this.dataToBytecode(e);return q(this.getLockingBytecode(n),t,this.tokenAware)}static getSourceOutput(e,t){return{lockingBytecode:this.getLockingBytecode(e),valueSatoshis:BigInt(t.value),token:t.token_data?{category:u(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:u(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getInput(e,t){return{outpointIndex:t.tx_pos,outpointTransactionHash:u(t.tx_hash),sequenceNumber:0,unlockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value),token:t.token_data?{category:u(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:u(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}}static getDeposit(e,t){return{lockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(t)}}static getOutput(e,t){let n=t.value>this.EXECUTOR_FEE+800?t.value-this.EXECUTOR_FEE:800n;return{lockingBytecode:e.recipient,valueSatoshis:BigInt(n),token:t.token_data?{category:u(t.token_data.category),amount:BigInt(t.token_data.amount),nft:t.token_data.nft?{commitment:u(t.token_data.nft.commitment),capability:t.token_data.nft.capability}:void 0}:void 0}}static getExecutorOutput(e,t){let n=H(e);if(typeof n=="string")throw n;return{lockingBytecode:n.bytecode,valueSatoshis:BigInt(t)}}static fund(e,t,n,p,m,d=1){const l=[],o=[];let i=[];typeof n!="string"&&(n=b(n));let h=this.dataToBytecode({locktime:t,recipient:n}),a={locktime:0,version:2,inputs:l,outputs:o};a.outputs.push(this.getDeposit(h,e)),a=K(a,i,p,m);let s=g(a);if(!s.success)throw new Error("generate transaction failed!, errors: "+U(s.errors));let c=s.transaction;const r=P(s.transaction,d),E=a.outputs.length-1;if(a.outputs[E].valueSatoshis=a.outputs[E].valueSatoshis-r,s=g(a),!s.success)throw new Error("generate transaction failed!, errors: "+U(s.errors));c=s.transaction;const _=N(c,i,{maximumTokenCommitmentLength:128});if(_!==!0)throw _;let f=this.vm.verify({sourceOutputs:i,transaction:c});if(typeof f=="string")throw f;return{sourceOutputs:i,transaction:c,verify:f}}static execute(e,t,n,p=1){const m=[],d=[];let l=[],o={locktime:t,version:2,inputs:m,outputs:d};for(let c of e){let r=this.parseCommitment(c.record);Y(r.locktime)<=t&&(o.inputs.push(this.getInput(r,c.utxo)),o.outputs.push(this.getOutput(r,c.utxo)),l.push(this.getSourceOutput(r,c.utxo)))}n&&o.inputs.length>0&&o.outputs.push(this.getExecutorOutput(n,o.inputs.length*this.EXECUTOR_FEE));let i=g(o);if(!i.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(i.errors,null,"  "));if(n&&o.inputs.length>0){const c=P(i.transaction,p)+1n,r=o.outputs.length-1;o.outputs[r].valueSatoshis=o.outputs[r].valueSatoshis-c}if(i=g(o),!i.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(i.errors,null,"  "));const h=i.transaction,a=N(h,l,{maximumTokenCommitmentLength:40});if(a!==!0)throw a;let s=this.vm.verify({sourceOutputs:l,transaction:h});if(typeof s=="string")throw s;return{sourceOutputs:l,transaction:h,verify:s}}}var ct=y('<img alt="Disconnected"/>'),rt=y('<section><div class="status svelte-1hdjt3z"><!> <!></div> <!></section>');function Et(k,e){L(e,!0);var t=rt(),n=T(t),p=T(n);S(p,{get template(){return at.template}});var m=I(p,2);{var d=o=>{var i=ct();w(()=>R(i,"src",D)),O(o,i)};A(m,o=>{o(d,-1)})}v(n);var l=I(n,2);$(l),v(t),O(k,t),C()}export{Et as component,yt as universal};
//# sourceMappingURL=14.BXQ15G6n.js.map
