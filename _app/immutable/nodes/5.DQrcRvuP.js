import{f,a as p,c as K}from"../chunks/8oBGRZVN.js";import"../chunks/CVEFSApn.js";import{o as It,a as Tt}from"../chunks/DMW4kfRv.js";import{ar as kt,p as wt,c as o,t as P,a as Ut,g as i,b as w,ap as Nt,s as _,J as L,P as W,r,f as Z}from"../chunks/lteOEiVP.js";import{d as Dt,h as Bt,s as q}from"../chunks/tYMoxcZx.js";import{i as X}from"../chunks/DrKszRYN.js";import{e as tt,i as et}from"../chunks/DgylJ1ue.js";import{b as E,s as g}from"../chunks/Cp4mrthu.js";import{s as At}from"../chunks/8Bq62MGM.js";import{i as Ct}from"../chunks/BWV7w5QU.js";import{p as nt}from"../chunks/CGM4UnTN.js";import{b as st}from"../chunks/BtgC42a0.js";import{i as $,q as Mt,l as Rt,x as St,p as N,D as Vt,N as Lt,I as qt,G as Xt,H as $t,$ as at,m as it}from"../chunks/x8SFMCSp.js";import{B as Ft,C as Ht,D as Yt}from"../chunks/BlqHC1ME.js";const Gt=2,ot=(O,s=Gt)=>JSON.stringify(O,(n,a)=>{const m=typeof a=="object"&&a!==null?a.constructor.name:typeof a;switch(m){case"Uint8Array":return`<Uint8Array: 0x${$(a)}>`;case"bigint":return`<bigint: ${a.toString()}n>`;case"function":case"symbol":return`<${m}: ${a.toString()}>`;default:return a}},s),zt=!0,Ae=Object.freeze(Object.defineProperty({__proto__:null,prerender:zt},Symbol.toStringTag,{value:"Module"}));var Qt=f("<h3>About Drip Mine</h3> <p>Drip mine is a contract demonstrating the potential of Miner Extractable Value (MEV). Each output of the contract can be spent by anyone, each transaction generates fees that benefit miner that includes the transaction in a block.</p> <p>Bitcoin has always had builtin MEV, in the form of a block subsidy. The block subsidy, or block reward, is a way to create newly minted coins in the first transaction of a block (the coinbase transaction).</p> <p>As the idea of bitcoin continues to develop, on the Bitcoin Cash (BCH) fork, the built-in block subsidy will become less and less important and revenue from including transactions will come to dominate miner revenue.</p> <p>Anyone-can-spend outputs held by the drip-mine covenant by clicking the colorful icons above.</p> <p>When the value of an unspent transaction output locked by the covenant falls below 740 satoshis, all the value is claimed in the next transaction and the output is ‘burned’.</p> <p>Anyone may contribute to the MEV fund by sending outputs to the address below:</p>",1);function jt(O){var s=Qt();kt(12),p(O,s)}const Jt="https://libauth.org/schemas/wallet-template-v0.schema.json",Kt=`Drip Mine: An MEV faucet
