import{f as N,a as v}from"../chunks/Dpugy2Ee.js";import{o as Z,a as tt}from"../chunks/ar5gGZxr.js";import{aA as et,p as nt,aB as g,ao as R,a as it,c as D,s as F,ak as l,L as s,r as L,t as q}from"../chunks/D4dX0kjQ.js";import{i as at}from"../chunks/TPC8Xsa-.js";import{a as S}from"../chunks/ClBgvd6y.js";import{p as ot}from"../chunks/DmTerbQ1.js";import"../chunks/D1QZKn_k.js";import{B as st,t as rt}from"../chunks/2xXmZPXB.js";import{B as ct}from"../chunks/BFD75dqX.js";import{C as ut}from"../chunks/B7hCbxZp.js";import{D as lt}from"../chunks/DMvn4Q5j.js";import{e as pt,L as dt,g as ht,m as X,h as _,C as mt,D as gt,b as U,j as K,k as ft,M as T,r as H,a as C,l as M,p as Ot,v as kt,t as _t}from"../chunks/B8SFqfPN.js";import{d as bt}from"../chunks/B3i8XpOk.js";import{e as V,C as yt}from"../chunks/DxukWiye.js";import{I as Pt,B as Tt,W as It,T as Et,g as vt}from"../chunks/HTyFXHRh.js";const Ut=(b=!0)=>pt(dt(b)),Nt=!0,oe=Object.freeze(Object.defineProperty({__proto__:null,prerender:Nt},Symbol.toStringTag,{value:"Module"}));var xt=N('<h3>About Subscriptions</h3> <p>Setup subscriptions paying in CashTokens for regular payments to a pre-defined address.</p> <p>Subscribers can cancel at any time and withdraw the balance of the pre-paid fund using an NFT “key card”.</p> <p>More about the <a href="https://bitcoincashresearch.org/t/unspent-phi-v3-timelocking-token-aware-contracts/1501#subscriptions-share-vesting-revocable-token-annuities-3" rel="nofollow">contract here</a></p> <h3>See Also:</h3> <p><a href="https://github.com/KarolTrzeszczkowski/Mecenas-recurring-payment-EC-plugin" rel="nofollow">Mecenas</a> by Karol Trzeszczkowski (Licho#14431)</p>',1);function wt(b){var e=xt();et(10),v(b,e)}const Bt="https://libauth.org/schemas/wallet-template-v0.schema.json",St="Subscription: a CashToken contract for recurring automatic payments.",Ct="Subscription",At={covenant:{description:`Hold asset in escrow for a subscription. 
...
// }
//`}},Ft=["BCH_2023_05","BCH_2025_05","BCH_2026_05","BCH_SPEC"],Lt={$schema:Bt,description:St,name:Ct,entities:At,scenarios:Rt,scripts:Dt,supported:Ft},qt="@unspent/subscription",Xt={name:qt};class E{static USER_AGENT=Xt.name;static PROTOCOL_IDENTIFIER="U3S";static EXECUTOR_FEE=5e3;static tokenAware=!0;static template=Lt;static compiler=ht(this.template);static vm=Ut();static dataToBytecode(e){return{installment:X(e.installment),recipient:e.recipient,period:X(BigInt(e.period)),auth:new Uint8Array(e.auth).reverse()}}static parseNFT(e){if(e.token_data?.nft?.commitment){let t=bt(_(e.token_data?.nft?.commitment));if(mt(t[0])!==this.PROTOCOL_IDENTIFIER)throw Error("Non-subscription record NFT passed as subscription");return{installment:t[1],recipient:t[2],period:t[3],auth:_(e.token_data.category)}}else throw Error("Could not parse subscription NFT")}static encodeCommitment(e){let t=gt(`<"${this.PROTOCOL_IDENTIFIER}"><${e.installment}><0x${U(e.recipient)}><${e.period}>`);if(typeof t=="string")throw t;return U(t)}static getLockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getUnlockingBytecode(e){const t=this.compiler.generateBytecode({data:{bytecode:e},scriptId:"execute"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(e,t=!0){let o=this.dataToBytecode(e);return K(this.getLockingBytecode(o),t)}static getAddress(e,t="bitcoincash"){let o=this.dataToBytecode(e);return ft(this.getLockingBytecode(o),t,this.tokenAware)}static getSourceOutput(e,t){return{lockingBytecode:this.getLockingBytecode(e),valueSatoshis:BigInt(t.value),token:t.token_data?{category:_(t.token_data.category),amount:BigInt(t.token_data.amount)}:void 0}}static getInput(e,t,o){return{outpointIndex:t.tx_pos,outpointTransactionHash:_(t.tx_hash),sequenceNumber:o,unlockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"execute",valueSatoshis:BigInt(t.value),token:t.token_data?{category:_(t.token_data.category),amount:BigInt(t.token_data.amount)}:void 0}}}static getInstallmentOutput(e,t){let o=T(e.installment);if(typeof o=="string")throw o;return BigInt(t.token_data?.amount)<o&&(o=BigInt(t.token_data?.amount)),{lockingBytecode:e.recipient,valueSatoshis:800n,token:t.token_data?{category:_(t.token_data.category),amount:o}:void 0}}static getReturnOutput(e,t){let o=T(e.installment);if(typeof o=="string")throw o;return{lockingBytecode:{data:{bytecode:e},compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(t.value-this.EXECUTOR_FEE),token:t.token_data?{category:_(t.token_data.category),amount:BigInt(t.token_data.amount)-o}:void 0}}static getExecutorOutput(e,t){let o=H(e);if(typeof o=="string")throw o;return{lockingBytecode:o.bytecode,valueSatoshis:BigInt(t)}}static execute(e,t,o,x=1){const P=[],I=[];let k=[],r={locktime:0,version:2,inputs:P,outputs:I};for(let n of e){let i=this.parseNFT(n.record);if(n.utxo.height>0&&n.utxo.value>5800){const d=t-n.utxo.height,m=C(i.period),u=T(i.installment);if(typeof u=="string")throw u;d>=m&&BigInt(n.utxo.token_data?.amount)>=u&&(r.inputs.push(this.getInput(i,n.utxo,d)),r.outputs.push(this.getInstallmentOutput(i,n.utxo)),k.push(this.getSourceOutput(i,n.utxo)))}}for(let n of e){let i=this.parseNFT(n.record);if(n.utxo.height>0&&n.utxo.value>5800){const d=t-n.utxo.height,m=C(i.period),u=T(i.installment);if(typeof u=="string")throw u;d>=m&&BigInt(n.utxo.token_data?.amount)>=u&&r.outputs.push(this.getReturnOutput(i,n.utxo))}}for(let n of e){let i=this.parseNFT(n.record);if(n.utxo.height>0&&n.utxo.value>5800){const d=t-n.utxo.height,m=C(i.period),u=T(i.installment);if(typeof u=="string")throw u;d>=m&&BigInt(n.utxo.token_data?.amount)<u&&(r.inputs.push(this.getInput(i,n.utxo,d)),r.outputs.push(this.getInstallmentOutput(i,n.utxo)),k.push(this.getSourceOutput(i,n.utxo)))}}o&&r.inputs.length>0&&r.outputs.push(this.getExecutorOutput(o,r.inputs.length*(this.EXECUTOR_FEE-800)));let p=M(r);if(!p.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(p.errors,null,"  "));if(o&&r.inputs.length>0){const n=Ot(p.transaction,x)+1n,i=r.outputs.length-1;r.outputs[i].valueSatoshis=r.outputs[i].valueSatoshis-n}if(p=M(r),!p.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(p.errors,null,"  "));const h=p.transaction,f=kt(h,k,{maximumTokenCommitmentLength:40});if(f!==!0)throw f;let O=this.vm.verify({sourceOutputs:k,transaction:h});if(typeof O=="string")throw O;return{sourceOutputs:k,transaction:h,verify:O}}}var Mt=N("<img/>"),Vt=N('<img alt="Disconnected"/>'),Kt=N('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function se(b,e){nt(e,!0);const t=ot.url.hostname=="vox.cash";t?U(st):U(rt);const o=t?"bch.imaginary.cash":"chipnet.bch.ninja";let x=g(0),P=g(""),I=g(""),k=g(0),r=new Set,p=0,h,f=g(R([])),O=g(R([])),n=g(""),i=g(void 0),d="",m=g("");const u=async function(a){if(a.method==="blockchain.headers.subscribe"){let c=a.params[0];l(x,c.height,!0)}else a.method==="blockchain.scripthash.subscribe"?a.params[1]!==s(I)&&(l(I,a.params[1],!0),l(P,yt[s(i).status],!0),Y()):console.log(a)},Y=()=>{clearTimeout(p),p=setTimeout(()=>{Q(),W()},1500)},Q=async function(){let a=await s(i).request("blockchain.scripthash.listunspent",s(m),"include_tokens");if(a instanceof Error)throw a;l(O,a,!0),l(k,_t(s(O),!0),!0),l(O,s(O).filter(c=>!c.token_data).filter(c=>c.height>0),!0)},W=async function(){let a=await s(i).request("blockchain.scripthash.listunspent",d,"include_tokens");if(a instanceof Error)throw a;let c=new Set(a.map(y=>`${y.tx_hash}":"${y.tx_pos}`));(s(f).length==0||r.intersection(c).size==0)&&l(f,a,!0),l(f,s(f).filter(y=>y.height>0),!0),s(f).sort((y,J)=>y.height-J.height)};Z(async()=>{Tt.StorageProvider=Pt,h=t?await It.named("vox"):await Et.named("vox"),l(n,vt(h.mnemonic,h.derivationPath.slice(0,-2),h.isTestnet),!0);let a=H(h.getDepositAddress());if(typeof a=="string")throw a;l(m,K(a.bytecode),!0);let c={installment:100n,period:0,recipient:a.bytecode,auth:Uint8Array.from([])};E.getAddress(c),l(i,new V(E.USER_AGENT,"1.4.1",o),!0),await s(i).connect(),s(i).on("notification",u),await s(i).subscribe("blockchain.scripthash.subscribe",d),await s(i).subscribe("blockchain.scripthash.subscribe",s(m)),await s(i).subscribe("blockchain.headers.subscribe")}),tt(async()=>{await new V(E.USER_AGENT,"1.4.1",o).disconnect()});var w=Kt(),B=D(w),A=D(B);ct(A,{get template(){return E.template}});var $=F(A,2);{var z=a=>{var c=Mt();q(()=>{S(c,"src",ut),S(c,"alt",s(P))}),v(a,c)},j=a=>{var c=Vt();q(()=>S(c,"src",lt)),v(a,c)};at($,a=>{s(P)=="CONNECTED"?a(z):a(j,!1)})}L(B);var G=F(B,2);wt(G),L(w),v(b,w),it()}export{se as component,oe as universal};
//# sourceMappingURL=14.C3Cy52Ow.js.map
