import{f,a as p,c as J}from"../chunks/CbXCnxB4.js";import"../chunks/D1WwfAgW.js";import{o as Tt,a as kt}from"../chunks/CpBtQCBs.js";import{ak as It,p as wt,c as o,t as E,a as Ut,j as i,Z as w,ai as Nt,s as _,k as L,A as W,r,f as Z}from"../chunks/CfohlS-g.js";import{d as Dt,h as Bt,s as q}from"../chunks/KRKZFEQY.js";import{i as X}from"../chunks/CKdNsbcw.js";import{e as tt,i as et}from"../chunks/JCfAsYhq.js";import{a as P,s as g}from"../chunks/VLKSzg3l.js";import{s as At,b as nt}from"../chunks/CKYk6RRY.js";import{p as st,i as Ct}from"../chunks/BIsqRfBC.js";import{$ as at,a as it}from"../chunks/CQVT_UhJ.js";import{t as F,j as Mt,l as Rt,m as St,i as N,q as Vt,E as Lt,B as qt,F as Xt,G as Ft,H as $t,C as Ht,D as Yt}from"../chunks/DCFNDzAQ.js";const Gt=2,ot=(O,s=Gt)=>JSON.stringify(O,(n,a)=>{const m=typeof a=="object"&&a!==null?a.constructor.name:typeof a;switch(m){case"Uint8Array":return`<Uint8Array: 0x${F(a)}>`;case"bigint":return`<bigint: ${a.toString()}n>`;case"function":case"symbol":return`<${m}: ${a.toString()}>`;default:return a}},s),jt=!0,De=Object.freeze(Object.defineProperty({__proto__:null,prerender:jt},Symbol.toStringTag,{value:"Module"}));var zt=f("<h3>About Drip Mine</h3> <p>Drip mine is a contract demonstrating the potential of Miner Extractable Value (MEV). Each output of the contract can be spent by anyone, each transaction generates fees that benefit miner that includes the transaction in a block.</p> <p>Bitcoin has always had builtin MEV, in the form of a block subsidy. The block subsidy, or block reward, is a way to create newly minted coins in the first transaction of a block (the coinbase transaction).</p> <p>As the idea of bitcoin continues to develop, on the Bitcoin Cash (BCH) fork, the built-in block subsidy will become less and less important and revenue from including transactions will come to dominate miner revenue.</p> <p>Anyone-can-spend outputs held by the drip-mine covenant by clicking the colorful icons above.</p> <p>When the value of an unspent transaction output locked by the covenant falls below 740 satoshis, all the value is claimed in the next transaction and the output is ‘burned’.</p> <p>Anyone may contribute to the MEV fund by sending outputs to the address below:</p>",1);function Qt(O){var s=zt();It(12),p(O,s)}const Kt="https://libauth.org/schemas/wallet-template-v0.schema.json",Jt=`Drip Mine: An MEV faucet
