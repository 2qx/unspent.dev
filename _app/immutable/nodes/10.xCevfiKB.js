...
OP_CHECKSIG`}},oe=["BCH_2026_05","BCH_SPEC"],ae={$schema:z,description:Z,name:ee,entities:te,scenarios:ne,scripts:ie,supported:oe},se="@unspent/dutch",ce={name:se};class re{static USER_AGENT=ce.name;static PROTOCOL_IDENTIFIER="U3A";static tokenAware=!0;static template=ae;static compiler=U(this.template);static vm=H();static dataToBytecode(t){return{open:q(t.open),recipient:a(t.recipient)}}static parseCommitment(t){typeof t=="string"&&(t=a(t));const e=W(t);if(F(e[0])!==this.PROTOCOL_IDENTIFIER)throw Error(`"Non-${typeof this} record NFT passed as ${typeof this}"`);return{open:e[1],recipient:e[2]}}static encodeCommitment(t){let e=V(`<"${this.PROTOCOL_IDENTIFIER}"><${t.open}><0x${t.recipient}>
        `);if(typeof e=="string")throw e;return $(e)}static getLockingBytecode(t){const e=this.compiler.generateBytecode({data:{bytecode:t},scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(e,null,"  "));return e.bytecode}static getScriptHash(t,e=!0){let n=this.parseCommitment(t);return x(this.getLockingBytecode(n),e)}static getAddress(t,e="bitcoincash"){let n=this.dataToBytecode(t);return M(this.getLockingBytecode(n),e,this.tokenAware)}static getSourceOutput(t,e){return{lockingBytecode:this.getLockingBytecode(t),valueSatoshis:BigInt(e.value),token:e.token_data?{category:a(e.token_data.category),amount:BigInt(e.token_data.amount),nft:e.token_data.nft?{commitment:a(e.token_data.nft.commitment),capability:e.token_data.nft.capability}:void 0}:void 0}}static getInput(t,e,n){return{outpointIndex:e.tx_pos,outpointTransactionHash:a(e.tx_hash),sequenceNumber:n,unlockingBytecode:{data:{bytecode:t},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(e.value),token:e.token_data?{category:a(e.token_data.category),amount:BigInt(e.token_data.amount),nft:e.token_data.nft?{commitment:a(e.token_data.nft.commitment),capability:e.token_data.nft.capability}:void 0}:void 0}}}static getOutput(t,e){return{lockingBytecode:t.recipient,valueSatoshis:BigInt(e)}}static execute(t,e,n,c,d,l=0,h=1){let i={locktime:0,version:2,inputs:[],outputs:[]};const u=this.parseCommitment(t);let y=c-e.height,B=Math.round(Y(u.open)/y)+1;const p=[this.getSourceOutput(u,e)];i.inputs.push(this.getInput(u,e,y)),i.outputs.push(this.getOutput(u,B)),i=G(i,p,n,d,l);let o=T(i);if(!o.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(o.errors,null,"  "));const P=K(o.transaction,h),_=i.outputs.length-1;if(i.outputs[_].valueSatoshis=i.outputs[_].valueSatoshis-P,o=T(i),!o.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(o.errors,null,"  "));const g=o.transaction,v=Q(g,p,{maximumTokenCommitmentLength:40});if(v!==!0)throw v;let f=this.vm.verify({sourceOutputs:p,transaction:g});if(typeof f=="string")throw f;return{sourceOutputs:p,transaction:g,verify:f}}}var ue=k('<img alt="Disconnected"/>'),pe=k('<section><div class="status svelte-1e0u92t"><!> <!></div> <!></section>');function ve(s,t){A(t,!0);var e=pe(),n=O(e),c=O(n);N(c,{get template(){return re.template}});var d=E(c,2);{var l=r=>{var m=ue();C(()=>L(m,"src",R)),b(r,m)};D(d,r=>{r(l,-1)})}I(n);var h=E(n,2);X(h),I(e),b(s,e),w()}export{ve as component,_e as universal};
//# sourceMappingURL=10.xCevfiKB.js.map
