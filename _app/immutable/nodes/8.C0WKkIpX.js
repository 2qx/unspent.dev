import{f as p,a as c,c as Z}from"../chunks/D4WI2l91.js";import"../chunks/DLnyVmsO.js";import{o as Tt,a as It}from"../chunks/Cc7MEs83.js";import{av as kt,p as wt,t as x,a as Ut,at as Dt,c as l,s as _,F as X,E as a,n as tt,r as u,aj as A,f as q}from"../chunks/CR0roo4h.js";import{d as Nt,h as Bt,s as At}from"../chunks/ot5Lq6mP.js";import{i as M}from"../chunks/CnK2uT91.js";import{e as et,i as nt}from"../chunks/CEwtjCVU.js";import{a as y,s as m}from"../chunks/BmSY798_.js";import{s as Mt}from"../chunks/CZebDG6o.js";import{i as Rt}from"../chunks/DI9_siVL.js";import{p as st}from"../chunks/DTwPawb1.js";import{b as at}from"../chunks/B8sppVjI.js";import{$ as Ct,a as it}from"../chunks/BDt1pbpk.js";import{g as Vt,d as St,e as jt,h as C,f as Lt,b as ct,D as Ft,E as Xt,F as qt,G as Yt}from"../chunks/DJI3uLfv.js";import{s as ot}from"../chunks/D9CDrku5.js";import{C as Ht}from"../chunks/B7hCbxZp.js";import{B as $t,D as Gt}from"../chunks/ak8h_1A1.js";const zt=!0,je=Object.freeze(Object.defineProperty({__proto__:null,prerender:zt},Symbol.toStringTag,{value:"Module"}));var Qt=p("<h3>About Drip Mine</h3> <p>Drip mine is a contract demonstrating the potential of Miner Extractable Value (MEV). Each output of the contract can be spent by anyone, each transaction generates fees that benefit miner that includes the transaction in a block.</p> <p>Bitcoin has always had builtin MEV, in the form of a block subsidy. The block subsidy, or block reward, is a way to create newly minted coins in the first transaction of a block (the coinbase transaction).</p> <p>As the idea of bitcoin continues to develop, on the Bitcoin Cash (BCH) fork, the built-in block subsidy will become less and less important and revenue from including transactions will come to dominate miner revenue.</p> <p>Anyone-can-spend outputs held by the drip-mine covenant by clicking the colorful icons above.</p> <p>When the value of an unspent transaction output locked by the covenant falls below 740 satoshis, all the value is claimed in the next transaction and the output is ‘burned’.</p> <p>Anyone may contribute to the MEV fund by sending outputs to the address below:</p>",1);function Kt(I){var n=Qt();kt(12),c(I,n)}const Wt="https://libauth.org/schemas/wallet-template-v0.schema.json",Jt=`Drip Mine: An MEV faucet
...
// contract DripMine() {
    ...
    OP_DROP OP_1
// }
`}},se=["BCH_2023_05"],ae=0,ie={$schema:Wt,description:Jt,name:Zt,entities:te,scenarios:ee,scripts:ne,supported:se,version:ae},oe="@unspent/drip",re={name:oe},rt=576,R=164,ce=4392,le=1333036486;class T{static USER_AGENT=re.name;static template=ie;static compiler=Vt(this.template);static getLockingBytecode(n={}){const e=this.compiler.generateBytecode({data:n,scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+ot(e));return e.bytecode}static getScriptHash(n=!0){return St(this.getLockingBytecode(),n)}static getAddress(n="bitcoincash"){return jt(this.getLockingBytecode(),n)}static getOutput(n){let e=Math.round(n.value*ce/le)-1;e=e<R?R:e;let i=n.value-e;return n.value>BigInt(rt+R)?{lockingBytecode:{compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(i)}:{lockingBytecode:C("6a"),valueSatoshis:BigInt(0)}}static getInput(n){let e=n.value>BigInt(rt+R)?"unlock_return":"unlock_burn";return{outpointIndex:n.tx_pos,outpointTransactionHash:C(n.tx_hash),sequenceNumber:1,unlockingBytecode:{compiler:this.compiler,script:e,valueSatoshis:BigInt(n.value)}}}static processOutpoint(n){const e=[],i=[];i.push(this.getOutput(n)),e.push(this.getInput(n));const f=Lt({locktime:0,version:2,inputs:e,outputs:i});if(!f.success)throw new Error("generate transaction failed!, errors: "+ot(f.errors));return ct(Ft(f.transaction))}}const ue="data:image/svg+xml,%3csvg%20style='height:400px;width:400px'%20version='1.1'%20viewBox='0%200%2016%2016'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3e%3cdefs%3e%3cradialGradient%20id='a'%20cx='7.24'%20cy='7.07'%20r='3.73'%20gradientTransform='matrix(-.551%201.72%20-1.8%20-.576%2022.2%20-.713)'%20gradientUnits='userSpaceOnUse'%3e%3cstop%20stop-color='%23b7ffff'%20stop-opacity='.839'%20offset='.05'/%3e%3cstop%20stop-color='%230052ef'%20offset='.95'/%3e%3c/radialGradient%3e%3c/defs%3e%3cpath%20d='m8.28%203.09c0.21-0.784%203.87%202.13%203.87%205.16%200%201.99-1.34%203.52-3.57%203.51-2.44%200-3.9-1.33-3.9-3.23%200-2.05%202.88-2.74%203.6-5.44z'%20fill='url(%23a)'/%3e%3c/svg%3e";var pe=p('<meta name="description" content="Release the miner extractable value (MEV)!"/>'),de=p("<img/>"),he=p('<img alt="Disconnected"/>'),me=(I,n)=>n(),ve=p('<div class="row svelte-1jxmddj"><button class="svelte-1jxmddj"><img/></button></div>'),_e=p("<p>No spendable outputs, check back in 10 minutes.</p>"),fe=p('<div class="row svelte-1jxmddj"><button disabled class="svelte-1jxmddj"><img/></button></div>'),ge=p("<p>No pending transactions</p>"),be=p('<div class="header svelte-1jxmddj"><button class="svelte-1jxmddj">Release all Miner Extractable Value (MEV)</button></div> <h3>Unspent Transaction Outputs (utxos)</h3> <div class="grid svelte-1jxmddj"><!></div> <h3>Mempool Transactions</h3> <div class="grid svelte-1jxmddj"><!></div>',1),Oe=p('<div class="swap svelte-1jxmddj"><p>Not connected?</p></div>'),Ee=p('<section class="svelte-1jxmddj"><div class="status svelte-1jxmddj"><!> <!></div> <h1>Release the miner extractable value (MEV)</h1> <!> <!> <qr-code><img width="50px" slot="icon" alt="drip MEV icon"/></qr-code> <pre id="deposit"> </pre></section>',2);function Le(I,n){wt(n,!1);let e=tt([]),i,N="";N=T.getScriptHash();let f="",k=tt(""),V=new Set,Y,H=st.url.hostname=="vox.cash"?"bitcoincash":"bchtest",lt=st.url.hostname=="vox.cash"?"bch.imaginary.cash":"chipnet.bch.ninja";const ut=()=>{clearTimeout(Y),Y=setTimeout(()=>{V=new Set},1e4)},pt=function(t){t.method==="blockchain.scripthash.subscribe"?t.params[1]!==f&&(f=t.params[1],A(k,it[i.status]),G()):console.log(t)},dt=async function(t){let s=await i.request("blockchain.transaction.broadcast",t);if(s instanceof Error)throw A(k,it[i.status]),s},ht=function(){a(e).filter(t=>t.height>0).map((t,s)=>{$(t,s)})},$=async function(t,s){let h=T.processOutpoint(t),w=Xt(C(h));if(typeof w=="string")throw w;V.add(`${t.tx_hash}":"${t.tx_pos}`),ut();let g=qt(ct(Yt(C(h)))),U=Number(w.outputs[0].valueSatoshis);a(e).splice(s,1);let L=a(e).filter(b=>b.height>0||b.value<U?!0:b.value==U&&b.tx_hash<g).length;a(e).splice(L,0,{height:0,tx_hash:g,value:U}),A(e,a(e)),await dt(h)},G=async function(){let t=await i.request("blockchain.scripthash.listunspent",N,"exclude_tokens");if(t instanceof Error)throw t;let s=new Set(t.map(h=>`${h.tx_hash}":"${h.tx_pos}`));(a(e).length==0||V.intersection(s).size==0)&&A(e,t)};Tt(async()=>{i=new Ct(T.USER_AGENT,"1.4.1",lt),await i.connect(),i.on("notification",pt),await i.subscribe("blockchain.scripthash.subscribe",N),G()}),It(async()=>{await i.disconnect()}),Rt();var S=Ee();Bt(t=>{var s=pe();Dt.title="Drip Mine",c(t,s)});var j=l(S),z=l(j);$t(z,{get template(){return T.template}});var mt=_(z,2);{var vt=t=>{var s=de();x(()=>{m(s,"src",Ht),m(s,"alt",a(k))}),c(t,s)},_t=t=>{var s=he();x(()=>m(s,"src",Gt)),c(t,s)};M(mt,t=>{a(k)=="CONNECTED"?t(vt):t(_t,!1)})}u(j);var Q=_(j,4);{var ft=t=>{var s=be(),h=q(s),w=l(h);w.__click=[me,ht],u(h);var g=_(h,4),U=l(g);{var L=o=>{var r=Z(),F=q(r);et(F,1,()=>a(e).filter(v=>v.height>0),nt,(v,O,D)=>{var E=ve(),P=l(E);P.__click=()=>$(a(O),D);var B=l(P);u(P),u(E),x(yt=>{m(B,"src",yt),m(B,"alt",a(O).tx_hash)},[()=>at(`0x${a(O).tx_hash}`,32)],X),c(v,E)}),c(o,r)},b=o=>{var r=_e();c(o,r)};M(U,o=>{a(e).filter(r=>r.height>0).length>0?o(L):o(b,!1)})}u(g);var J=_(g,4),Et=l(J);{var Pt=o=>{var r=Z(),F=q(r);et(F,1,()=>a(e).filter(v=>v.height<=0),nt,(v,O)=>{var D=fe(),E=l(D),P=l(E);u(E),u(D),x(B=>{m(P,"src",B),m(P,"alt",a(O).tx_hash)},[()=>at(`0x${a(O).tx_hash}`,32)],X),c(v,D)}),c(o,r)},xt=o=>{var r=ge();c(o,r)};M(Et,o=>{a(e).filter(r=>r.height<=0).length>0?o(Pt):o(xt,!1)})}u(J),c(t,s)},gt=t=>{var s=Oe();c(t,s)};M(Q,t=>{a(k)=="CONNECTED"?t(ft):t(gt,!1)})}var K=_(Q,2);Kt(K);var d=_(K,2);y(d,"id","qr1"),x(()=>y(d,"contents",T.getAddress(H))),y(d,"module-color","#000"),y(d,"position-ring-color","#0052ef"),y(d,"position-center-color","#b7ffff"),y(d,"mask-x-to-y-ratio","1.2"),Mt(d,`width: 150px;
									height: 150px;
									margin: 0.5em auto;
									background-color: #fff;`);var bt=l(d);u(d);var W=_(d,2),Ot=l(W,!0);u(W),u(S),x(t=>{m(bt,"src",ue),At(Ot,t)},[()=>T.getAddress(H)],X),c(I,S),Ut()}Nt(["click"]);export{Le as component,je as universal};
//# sourceMappingURL=8.C0WKkIpX.js.map
