...
OP_CHECKSIG`}},$=["BCH_2023_05","BCH_2024_05","BCH_2025_05","BCH_SPEC"],K=0,Q={$schema:q,description:V,name:F,entities:j,scenarios:M,scripts:Y,supported:$,version:K},G="@unspent/dutch",W={name:G};class X{static USER_AGENT=W.name;static PROTOCOL_IDENTIFIER="U3A";static tokenAware=!0;static template=Q;static compiler=A(this.template);static vm=R();static dataToBytecode(n){return{open:P(n.locktime),recipient:p(n.recipient)}}static getLockingBytecode(n,e){typeof e=="string"&&(e=p(e));const t=this.compiler.generateBytecode({data:{bytecode:{open:k(BigInt(n)),recipient:e}},scriptId:"lock"});if(!t.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(t,null,"  "));return t.bytecode}static getScriptHash(n,e,t=!0){return S(this.getLockingBytecode(n,e),t)}static getAddress(n,e,t="bitcoincash"){return w(this.getLockingBytecode(n,e),t,this.tokenAware)}static getSourceOutput(n,e,t){return{lockingBytecode:this.getLockingBytecode(n,e),valueSatoshis:BigInt(t.value)}}static getInput(n,e,t){return typeof e=="string"&&(e=p(e)),{outpointIndex:t.tx_pos,outpointTransactionHash:p(t.tx_hash),sequenceNumber:t.value,unlockingBytecode:{data:{bytecode:{open:k(BigInt(n)),recipient:e}},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static getSourceOutputs(n,e,t){const o=[];return o.push(...t.map(r=>this.getSourceOutput(n,e,r))),o}static bid(n,e,t){let u={locktime:0,version:2,inputs:[],outputs:[]};u.inputs.push(this.getInput(n,e,t));let c=D(u);if(!c.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(c.errors,null,"  "));const i=[this.getSourceOutput(n,e,t)],s=c.transaction,h=C(s,i,{maximumTokenCommitmentLength:40});if(h!==!0)throw h;let g=this.vm.verify({sourceOutputs:i,transaction:s});if(typeof g=="string")throw g;return L(H(s))}}var J=d('<img alt="Disconnected"/>'),z=d('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function ue(a,n){_(n,!0);var e=z(),t=m(e),o=m(t);T(o,{get template(){return X.template}});var r=b(o,2);{var u=i=>{var s=J();O(()=>E(s,"src",I)),l(i,s)};B(r,i=>{i(u,!1)})}f(t);var c=b(t,2);x(c),f(e),l(a,e),v()}export{ue as component,re as universal};
//# sourceMappingURL=9.C-OvB-g0.js.map
