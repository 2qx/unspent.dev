...
// }
//}`}},X=["BCH_2022_05","BCH_2023_05","BCH_2024_05","BCH_2025_05","BCH_SPEC"],w={$schema:C,description:L,name:S,entities:V,scenarios:H,scripts:q,supported:X},Y="@unspent/trust",F={name:Y},M=4383,j=989995,Q=1e6;class ${static USER_AGENT=F.name;static template=w;static compiler=y(this.template);static getLockingBytecode(t={}){const e=this.compiler.generateBytecode({data:t,scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+h(e));return e.bytecode}static getScriptHash(t=!0){return k(this.getLockingBytecode(),t)}static getAddress(t="bitcoincash"){return U(this.getLockingBytecode(),t)}static getOutput(t){let e=Math.round(t.value*j/Q)-1;return{lockingBytecode:{compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(e)}}static getInput(t){return{outpointIndex:t.tx_pos,outpointTransactionHash:B(t.tx_hash),sequenceNumber:M,unlockingBytecode:{compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static processOutpoint(t){const e=[],n=[];n.push(this.getOutput(t)),e.push(this.getInput(t));const s=b({locktime:0,version:2,inputs:e,outputs:n});if(!s.success)throw new Error("generate transaction failed!, errors: "+h(s.errors));return x(N(s.transaction))}}var G=r('<img alt="Disconnected"/>'),z=r('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function it(o,t){O(t,!0);var e=z(),n=p(e),i=p(n);T(i,{get template(){return $.template}});var s=l(i,2);{var m=c=>{var u=G();E(()=>v(u,"src",f)),a(c,u)};I(s,c=>{c(m,!1)})}d(n);var _=l(n,2);D(_),d(e),a(o,e),P()}export{it as component,ot as universal};
//# sourceMappingURL=15.pZwaW8I5.js.map
