import{f as r,a as c}from"../chunks/DTc5U4eY.js";import{aA as g,p as O,a as P,c as p,s as l,r as d,t as E}from"../chunks/CQU5mOuk.js";import{i as I}from"../chunks/CZ0rTjPC.js";import{s as f}from"../chunks/-rOGAMhN.js";import"../chunks/CuzQ0eOn.js";import{B as v}from"../chunks/C-W6z3kR.js";import{D as T}from"../chunks/DMvn4Q5j.js";import{g as y,d as k,e as U,h as B,f as b,b as x,D as N}from"../chunks/BurMas-X.js";import{s as h}from"../chunks/BroIPJ_M.js";const R=!0,it=Object.freeze(Object.defineProperty({__proto__:null,prerender:R},Symbol.toStringTag,{value:"Module"}));var A=r('<h3>About Irrevocable Trusts</h3> <p>An unspent trust is a simple monthly annuity.</p> <p>Checkout the earlier version at <a href="https://unspent.cash" rel="nofollow">unspent.cash</a>.</p>',1);function D(o){var t=A();g(4),c(o,t)}const C="https://libauth.org/schemas/wallet-template-v0.schema.json",L="Pay one percent of a fund monthly in perpetuity",S="Perpetuity",V={trust:{description:"Contract creation and function trust",name:"Trust configuration",scripts:["lock","unlock"],variables:{recipient:{description:"Locking bytecode receiving payments",name:"recipientLockingBytecode",type:"WalletData"}}}},H={installment:{data:{bytecode:{recipient:"0xa914e78564d75c446f8c00c757a2bd783d30c4f0819a87"}},description:"Pay a monthly installment.",name:"Installment",transaction:{inputs:[{outpointTransactionHash:"dead00000000000000000000000000000000000000000000000000000000beef",outpointIndex:0,unlockingBytecode:["slot"],sequenceNumber:4383}],outputs:[{lockingBytecode:"a914e78564d75c446f8c00c757a2bd783d30c4f0819a87",valueSatoshis:1e5},{lockingBytecode:{},valueSatoshis:9899950}],version:2},sourceOutputs:[{lockingBytecode:["slot"],valueSatoshis:1e7}]}},q={unlock:{passes:["installment"],name:"unlock",script:`// 
// none
...
// }
//}`}},w=["BCH_2022_05","BCH_2023_05","BCH_2024_05","BCH_2025_05","BCH_SPEC"],X={$schema:C,description:L,name:S,entities:V,scenarios:H,scripts:q,supported:w},Y="@unspent/trust",F={name:Y},M=4383,j=989995,Q=1e6;class ${static USER_AGENT=F.name;static template=X;static compiler=y(this.template);static getLockingBytecode(t={}){const e=this.compiler.generateBytecode({data:t,scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+h(e));return e.bytecode}static getScriptHash(t=!0){return k(this.getLockingBytecode(),t)}static getAddress(t="bitcoincash"){return U(this.getLockingBytecode(),t)}static getOutput(t){let e=Math.round(t.value*j/Q)-1;return{lockingBytecode:{compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(e)}}static getInput(t){return{outpointIndex:t.tx_pos,outpointTransactionHash:B(t.tx_hash),sequenceNumber:M,unlockingBytecode:{compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static processOutpoint(t){const e=[],n=[];n.push(this.getOutput(t)),e.push(this.getInput(t));const s=b({locktime:0,version:2,inputs:e,outputs:n});if(!s.success)throw new Error("generate transaction failed!, errors: "+h(s.errors));return x(N(s.transaction))}}var G=r('<img alt="Disconnected"/>'),z=r('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function at(o,t){O(t,!0);var e=z(),n=p(e),i=p(n);v(i,{get template(){return $.template}});var s=l(i,2);{var m=a=>{var u=G();E(()=>f(u,"src",T)),c(a,u)};I(s,a=>{a(m,!1)})}d(n);var _=l(n,2);D(_),d(e),c(o,e),P()}export{at as component,it as universal};
//# sourceMappingURL=16.78DHljUg.js.map
