import{g as s,i as _}from"./index-ae3edba1.js";async function l(r,e,t,o=25,c=0){e=e||"6a04"+_,t=t||"mainnet";let a=await s({url:r,method:"post",data:{query:`query SearchOutputsByLockingBytecodePrefix($prefix: String!, $node: String!, $exclude_pattern: String!, $limit:Int, $offset:Int) {
...
//# sourceMappingURL=provider-34cd7cce.js.map
