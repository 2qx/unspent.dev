import{g as p,i as l,j as d,h as u,u as h,k as m,l as g,m as y,v as k}from"./DV8mz8xb.js";const f="https://libauth.org/schemas/wallet-template-v0.schema.json",O="Small Index: A distributed key-value database system.",T="SmallIndex",b={small_index_covenant:{description:`Store data records in NFT commitments. 
...
//    }
// }`}},_=["BCH_2023_05","BCH_SPEC"],I=0,P={$schema:f,description:O,name:T,entities:b,scenarios:v,scripts:E,supported:_,version:I},S="@unspent/small",x={name:S};class N{static USER_AGENT=x.name;static PROTOCOL_IDENTIFIER="U3R";static VERSION="1.0.0";static tokenAware=!0;static template=P;static compiler=p(this.template);static vm=l();static parseKey(t){return typeof t=="string"&&(d(t)?t=u(t):t=h(t)),t}static getLockingBytecode(t){const e=this.compiler.generateBytecode({data:{bytecode:{key:this.parseKey(t)}},scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(e,null,"  "));return e.bytecode}static getScriptHash(t,e=!0){return m(this.getLockingBytecode(t),e)}static getAddress(t,e="bitcoincash"){return g(this.getLockingBytecode(t),e,this.tokenAware)}static getSourceOutput(t,e){return{lockingBytecode:this.getLockingBytecode(t),valueSatoshis:BigInt(e.value)}}static getSourceOutputs(t,e){return e.map(n=>this.getSourceOutput(t,n))}static getInput(t,e){return{outpointIndex:e.tx_pos,outpointTransactionHash:u(e.tx_hash),sequenceNumber:e.value,unlockingBytecode:{data:{bytecode:{key:this.parseKey(t)}},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(e.value)}}}static getInputs(t,e){return e.map(n=>this.getInput(t,n))}static getOutput(){return{lockingBytecode:{data:{},compiler:this.compiler,script:"op_return"},valueSatoshis:BigInt(0)}}static drop(t,e){let s={locktime:0,version:2,inputs:[],outputs:[]};s.inputs.push(...this.getInputs(t,e)),s.outputs.push(this.getOutput());let a=y(s);if(!a.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(a.errors,null,"  "));const o=[...this.getSourceOutputs(t,e)],r=a.transaction,c=k(r,o,{maximumTokenCommitmentLength:40});if(c!==!0)throw c;let i=this.vm.verify({sourceOutputs:o,transaction:r});if(typeof i=="string")throw Error(i);return{sourceOutputs:o,transaction:r,verify:i}}}export{N as S};
//# sourceMappingURL=PKeEtYVC.js.map
