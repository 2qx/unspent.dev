...
// }
//}`},wallet_lock:{lockingType:"standard",name:"Wallet Lock",script:"OP_DUP OP_HASH160 <$(<key.public_key> OP_HASH160)> OP_EQUALVERIFY OP_CHECKSIG"}},K=["BCH_2023_05","BCH_SPEC"],F={$schema:L,description:V,name:q,entities:x,scenarios:D,scripts:H,supported:K},X="@unspent/blockpoint",Y={name:X},I=i("7fe0cd5197494e47ade81eb164dcdbd51859ffbe581fe4a818085d56b2f3062c"),G=i("8214f234225e5f555663290e0fb7b7b607bf0778221e6da97248bf020306831b");class W{static USER_AGENT=Y.name;static tokenAware=!0;static template=F;static compiler=A(this.template);static vm=N();static getLockingBytecode(t={}){const e=this.compiler.generateBytecode({data:t,scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+JSON.stringify(e,null,"  "));return e.bytecode}static getScriptHash(t=!0){return S(this.getLockingBytecode(),t)}static getAddress(t="bitcoincash"){return U(this.getLockingBytecode(),t,this.tokenAware)}static getSourceOutput(t){return{lockingBytecode:this.getLockingBytecode(),valueSatoshis:BigInt(t.value),token:{category:i(t.token_data.category),amount:BigInt(t.token_data?.amount)}}}static getInput(t,e){return{outpointIndex:t.tx_pos,outpointTransactionHash:i(t.tx_hash),sequenceNumber:e,unlockingBytecode:{data:{bytecode:{age:y(BigInt(e))}},compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static getOutput(t,e,n){return{lockingBytecode:{data:{bytecode:{age:y(BigInt(n))}},compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(t.value),token:{category:i(t.token_data.category),amount:BigInt(t.token_data?.amount)-BigInt(e)}}}static getWalletSourceOutput(t,e){return{lockingBytecode:e?R({addressIndex:0,hdPrivateKey:e}):Uint8Array.from(Array(33)),valueSatoshis:BigInt(t.value),token:t.token_data?{category:i(t.token_data.category),amount:BigInt(t.token_data?.amount)}:void 0}}static getWalletInput(t,e,n,o=0){const a=n?{compiler:this.compiler,data:{hdKeys:{addressIndex:o,hdPrivateKeys:{wallet:n}}},script:"wallet_unlock",valueSatoshis:BigInt(t.value)}:Uint8Array.from(Array());return{outpointIndex:t.tx_pos,outpointTransactionHash:i(t.tx_hash),sequenceNumber:e,unlockingBytecode:a}}static getTokenOutput(t,e,n=0,o=I){return{lockingBytecode:e?{compiler:this.compiler,data:{hdKeys:{addressIndex:n,hdPublicKeys:{wallet:P(e).hdPublicKey}}},script:"wallet_lock"}:Uint8Array.from(Array(33)),valueSatoshis:800n,token:{category:o,amount:BigInt(t)}}}static getChangeOutput(t,e,n=0){return{lockingBytecode:e?{compiler:this.compiler,data:{hdKeys:{addressIndex:n,hdPublicKeys:{wallet:P(e).hdPublicKey}}},script:"wallet_lock"}:Uint8Array.from(Array(33)),valueSatoshis:BigInt(t.value)-800n}}static getSourceOutputs(t,e,n){const o=[];return o.push(this.getWalletSourceOutput(e,n)),o.push(this.getSourceOutput(t)),o}static claim(t,e,n,o,a,h=1){const T=[],B=[];let v=a?i(a):I;const b=n.height>e.height?n.height:e.height,d=t-b,g=Math.floor(d*n.value/1e8);let s={locktime:0,version:2,inputs:T,outputs:B};s.inputs.push(this.getWalletInput(n,d,o)),s.outputs.push(this.getTokenOutput(g,o,0,v)),s.inputs.push(this.getInput(e,d)),s.outputs.push(this.getOutput(e,g,d)),s.outputs.push(this.getChangeOutput(n,o,0));let c=_(s);if(!c.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(c.errors,null,"  "));const f=w(c.transaction,h);if(s.outputs[2].valueSatoshis=s.outputs[2].valueSatoshis-f,c=_(s),!c.success)throw new Error("generate transaction failed!, errors: "+JSON.stringify(c.errors,null,"  "));const r=this.getSourceOutputs(e,n,o),u=c.transaction,k=C(u,r,{maximumTokenCommitmentLength:40});if(k!==!0&&h>0)throw k;let l=this.vm.verify({sourceOutputs:r,transaction:u});if(typeof l=="string")throw Error(l);let m=E(r)-E(u.outputs);m>5e3&&(l=`Excessive fees ${m}`),p(r,a)==0n&&(l="Error checking token input");let O=p(r,a)-p(u.outputs,a);if(O!==0n)throw Error(`Claiming should not create destroy tokens, token difference: ${O}`);return{sourceOutputs:r,transaction:u,verify:l}}}export{I as B,W as a,G as t};
//# sourceMappingURL=Bfc6EECp.js.map
